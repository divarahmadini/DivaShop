...
if(isset($_POST['add_to_cart'])){
   ...
   if($check_cart_numbers->rowCount() > 0){
      $message[] = 'Produk Sudah Tersedia di Keranjang';
   }else{
...
<section class="wishlist">
   ...
   <?php
      ...
      echo '<p class="empty">Tidak ada produk yang anda suka</p>';
   }
   ?>
   </div>
   ...
   <div class="wishlist-total">
      ...
      <a href="shop.php" class="option-btn">coba belanja</a>
      <a href="wishlist.php?delete_all" class="delete-btn <?= ($grand_total > 1)?'':'disabled'; ?>">hapus semua</a>
   </div>
