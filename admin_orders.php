...
<section class="placed-orders">
   ...
   <div class="box-container">
      ...
      ?>
      <div class="box">
        <p> Tgl pemesanan: <span><?= $fetch_orders['placed_on']; ?></span> </p>
         <p> Nama : <span><?= $fetch_orders['name']; ?></span> </p>
         <p> Email : <span><?= $fetch_orders['email']; ?></span> </p>
         <p> Nomorr : <span><?= $fetch_orders['number']; ?></span> </p>
         ...
         <form action="" method="POST">
            ...
            <div class="flex-btn">
               ...
               <a href="admin_orders.php?delete=<?= $fetch_orders['id']; ?>" class="delete-btn" onClick="return confirm('delete this order?');">hapus</a>
            </div>
         </form>
     </div>
      <?php
