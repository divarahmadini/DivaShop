   ...
   <form action="" method="POST" enctype="multipart/form-data">
      ...
      <div class="flex">
         ...
         <div class="inputBox">
            ...
            <input type="password" name="update_pass" placeholder="Masukkan sandi lama" class="box">
            <span>Sandi Baru :</span>
            <input type="password" name="new_pass" placeholder="Masukkan sandi baru" class="box">
            <span>Konfir Sandi Baru :</span>
            <input type="password" name="confirm_pass" placeholder="Masukkan sandi baru" class="box">
         </div>
      </div>
      <div class="flex-btn">
         <input type="submit" class="btn" value="ubah profil" name="update_profile">
         <a href="home.php" class="option-btn">Kembali</a>
      </div>
   </form>
