...
<section class="contact">
   ...
   <form action="" method="POST">
      ...
      <input type="number" name="number" min="0" class="box" required placeholder="masukkan nomor anda">
      <textarea name="msg" class="box" required placeholder="Pesan..." cols="30" rows="10"></textarea>
